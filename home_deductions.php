...
<?php
  ...
  while($row=mysqli_fetch_array($query))
  {
    ...
    $total        = $philhealth + $bir + $gsis + ((30-$days)*100) + $loans;
  }
?>
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active">
              <a data-toggle="modal" href="#deductions" style="color:black;">Loss of Pay</a>
            </li>
            <li>
              ...
              <form class="form-horizontal" action="#" name="form">
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">PhilHealth  :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $philhealth; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">BIR :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $bir; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">GSIS  :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $gsis; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">No. of days  :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $days; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">Loans :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $loans; ?>.00
                  </div>
                </div><br><br>
                <div class="form-group">
                  <label class="col-sm-5 control-label" style="color:white;">Total Deductions :</label>
                  <div class="col-sm-4" style="color:white;">
                    <?php echo $total; ?>.00
                  </div>
                </div>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="pag_ibig" class="form-control" value="<?php echo $days; ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
