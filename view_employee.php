          ...
          ?>
              ...
              <form class="form-horizontal" action="update_employee.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label" style = "color:white;">Lastname  :</label>
                    <div class="col-sm-4" style = "color:white;">
                      <input type="text" name="lname" class="form-control" value="<?php echo $row['lname'];?>" required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label " style = "color:white;">Firstname  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="fname" class="form-control" value="<?php echo $row['fname'];?>" required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label " style = "color:white;">Gender  :</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label " style = "color:white;">Employee Type  :</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label " style = "color:white;">Department  :</label>
                    <div class="col-sm-4">
