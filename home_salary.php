      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active" >
              <a href="" style="color:black;">Income</a>
            </li>
          </ul>
        </nav>
      </div>
                        ...
                        <?php
                          ...
                          while($row=mysqli_fetch_array($query))
                          {
                            ...
                            $over     = $row['overtime'] * $rate;
                             if($over > 0 and $overtime <=2)
                            {
                                $bonus = 1000;
                            }
                            else if($over > 2 and $overtime <=4)
                            {
                                $bonus = 2000;
                            }
                            else if($over > 4)
                            ...
                            $deduction  = $row['deduction'];
                              $deduction1 = $salary_rate - $deduction;
                            $income   = $over + $bonus + $salary_rate;
                            $netpay   = $income - $deduction;
                        ?>
                        <tr>
                          <td align="center"><?php echo $lname?>, <?php echo $fname?></td>
                          <td align="center"><big><b><?php echo $deduction1?></b></big>.00</td>
                          <td align="center"><big><b><?php
                            if(is_null($overtime))
                            {
                                echo "0";
                            }
