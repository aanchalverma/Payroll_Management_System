                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        <?php
                          ...
                          $query=mysqli_query($connection,"select * from employee ORDER BY emp_id asc")or die(mysqli_error());
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post">
                <div class="form-group">
                  <label class="col-sm-4 control-label" style="color:white;">Lastname</label>
                  <div class="col-sm-8">
                    <input type="text" name="lname" class="form-control" placeholder="Lastname" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label" style="color:white;">Firstname</label>
                  <div class="col-sm-8">
